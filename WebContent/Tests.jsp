...
<div class = "col">
	...
	<form method="post" action="Tests.jsp">
		Item code: <input name="itemCode" value="<%out.print(itemCode);%>" type="text" class = "form-control"><br> 
		Item name: <input name="itemName" value="<%out.print(itemName);%>" type="text" class = "form-control"><br> 
		Item price: <input name="itemPrice" value="<%out.print(itemPrice);%>" type="text" class = "form-control"><br> 
		Item description: <input name="itemDesc" value="<%out.print(itemDesc);%>" type="text" class = "form-control"><br>
